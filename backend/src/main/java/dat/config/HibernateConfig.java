...
public class HibernateConfig {
    ...
    private static EntityManagerFactory buildDevEntityManagerFactory() {
        try {
            ...
            if (isDeployed) {
                properties.put("hibernate.connection.url", System.getenv("CONNECTION_STR") + ApplicationConfig.getProperty("db.name"));
                ...
                properties.put("hibernate.connection.url", ApplicationConfig.getProperty("db.connection.string") + ApplicationConfig.getProperty("db.name"));
                properties.put("hibernate.connection.username", ApplicationConfig.getProperty("db.username"));
                properties.put("hibernate.connection.password", ApplicationConfig.getProperty("db.password"));
